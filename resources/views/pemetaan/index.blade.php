<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-4">
            ...
            <a href="{{ (Auth::check() && Auth::user()->role === 'user') ? route('dashboard') : url('/') }}" class="inline-flex items-center text-sm font-bold text-gray-500 hover:text-[#0E4D2B] transition-colors group">
