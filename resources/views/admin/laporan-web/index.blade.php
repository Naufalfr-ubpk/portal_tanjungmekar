...
<body class="font-sans antialiased bg-gray-100 text-gray-900" x-data="laporanWebManager()">
    ...
    <main class="md:ml-64 bg-gray-50 min-h-screen transition-all duration-300">
        ...
        <header class="bg-white h-20 shadow-sm border-b border-gray-200 flex items-center justify-between gap-4 lg:gap-8 px-4 md:px-8 z-10 sticky top-0">
            <div class="flex items-center gap-3 md:gap-6">
                ...
                <h2 class="text-lg md:text-xl font-bold text-gray-800 border-r-2 pr-4 md:pr-6 border-gray-300 whitespace-nowrap shrink-0">Laporan Web</h2>


                <div class="hidden md:flex items-center gap-3 lg:gap-5 text-xs lg:text-sm font-bold text-gray-500 whitespace-nowrap">
