...
<body class="font-sans antialiased bg-gray-100 text-gray-900 flex">
    ...
    <aside class="w-64 bg-[#0E4D2B] h-screen text-white flex flex-col shadow-xl fixed z-20">
        ...
        <!-- FOOTER SIDEBAR (DIAM/TIDAK SCROLL) "Kembali" Saja -->
    ...
    <main class="flex-1 ml-64 bg-gray-50 min-h-screen">
        ...
        <!-- HEADER KONTEN (Dashboard Teks Diperbaiki & Navlink Dibalikin) -->
        ...
        <div class="p-8">
            <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-8 mb-8">
                <h3 class="text-3xl font-extrabold text-[#0E4D2B] mb-2">Selamat Datang di Ruang Kendali!</h3>
                <p class="text-gray-600">Ini adalah *Content Management System* (CMS) khusus untuk mengatur keseluruhan Portal Tanjungmekar.</p>
            </div>
