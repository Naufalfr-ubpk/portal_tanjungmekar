...
<head>
    ...
    <style>
        ...
        /* CSS perbaikan efek hover hijau seperti sebelumnya */
    ...
    <main class="flex-1 ml-64 bg-gray-50 min-h-screen">
        ...
        <div class="p-8">
            <div class="flex justify-between items-center mb-6">
                <div>
                    <h2 class="text-2xl font-bold text-[#0E4D2B]">Daftar Pengajuan Pertanyaan Warga</h2>
                    <p class="text-gray-500 text-sm">Jawab dan publikasikan keluhan atau pertanyaan warga.</p>
                </div>
                <!-- Tombol ke halaman Kelola FAQ Web -->
                <a href="{{ route('admin.faq.bawaan') }}" class="bg-[#0E4D2B] text-white px-5 py-2.5 rounded-lg font-semibold hover:bg-green-800 transition shadow-md">Kelola FAQ Web</a>
            </div>
            ...
            <div class="flex gap-3 mb-4">
                <button @click="activeTab = 'semua'" :class="activeTab === 'semua' ? 'bg-[#0E4D2B] text-white' : 'bg-white text-gray-700 border-gray-300 hover:bg-gray-50'" class="px-5 py-2 rounded-full font-bold shadow-sm border transition text-sm">Semua</button>
                <button @click="activeTab = 'pending'" :class="activeTab === 'pending' ? 'bg-yellow-500 text-white border-yellow-500' : 'bg-white text-gray-700 border-gray-300 hover:bg-gray-50'" class="px-5 py-2 rounded-full font-bold shadow-sm border transition text-sm">Menunggu Jawaban</button>
                <button @click="activeTab = 'dipublikasi'" :class="activeTab === 'dipublikasi' ? 'bg-green-600 text-white border-green-600' : 'bg-white text-gray-700 border-gray-300 hover:bg-gray-50'" class="px-5 py-2 rounded-full font-bold shadow-sm border transition text-sm">Dipublikasi</button>
                <button @click="activeTab = 'ditolak'" :class="activeTab === 'ditolak' ? 'bg-red-600 text-white border-red-600' : 'bg-white text-gray-700 border-gray-300 hover:bg-gray-50'" class="px-5 py-2 rounded-full font-bold shadow-sm border transition text-sm">Ditolak</button>
            </div>
            ...
            <div class="bg-white rounded-xl shadow border border-gray-200 overflow-hidden">
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            <th class="px-6 py-4 text-left text-xs font-bold text-gray-500 uppercase">Nama / Waktu</th>
                            <th class="px-6 py-4 text-left text-xs font-bold text-gray-500 uppercase w-1/3">Pertanyaan</th>
