@php
    // Deteksi jika yang login beneran Operator ATAU Admin yang masuk lewat mode Operator
...
<head>
    ...
    <title>Kelola FAQ Web | Admin Portal</title>
        ...
        <div class="p-4 md:p-6">
            <div class="mb-6">
                ...
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    <div>
                        <h2 class="text-xl md:text-2xl font-bold text-[#0E4D2B]">Kelola FAQ Web</h2>
                        <p class="text-gray-500 text-sm">Kelola daftar pertanyaan default yang tampil di halaman FAQ Publik.</p>
                    </div>
                    <button @click="openModal('add')" class="w-full md:w-auto bg-[#0E4D2B] text-white px-5 py-2.5 rounded-lg font-semibold shadow-md hover:bg-green-800 transition flex items-center justify-center gap-2">
                ...
                <div class="overflow-x-auto w-full custom-scrollbar">
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                <th class="px-4 md:px-6 py-4 text-left text-xs font-bold text-gray-500 uppercase whitespace-nowrap">Pertanyaan</th>
                                <th class="px-4 md:px-6 py-4 text-center text-xs font-bold text-gray-500 uppercase w-32 whitespace-nowrap">Aksi</th>
                            </tr>
                        </thead>
                        <tbody class="divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50">
                                <td class="px-4 md:px-6 py-4">
                                    <div class="font-bold text-[#0E4D2B] text-sm md:text-lg mb-1">{{ $faq->pertanyaan }}</div>
                                </td>
                                <td class="px-4 md:px-6 py-4 flex items-center justify-center gap-2">
                    ...
                    <div class="p-5 md:p-6 overflow-y-auto custom-scrollbar flex-1 bg-white">
                        <form :action="formAction" method="POST">
                            ...
                            <div class="flex flex-col sm:flex-row justify-end gap-3 pt-4 border-t">
                                ...
                                <button type="submit" class="w-full sm:w-auto px-5 py-2.5 bg-[#0E4D2B] text-white font-bold rounded-lg shadow hover:bg-green-800 transition">Simpan FAQ Web</button>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <div x-show="deleteModalOpen" style="display: none;" class="fixed inset-0 z-[120] flex items-center justify-center bg-black bg-opacity-70 p-4">
                <div @click.away="closeDeleteModal()" class="bg-white rounded-2xl shadow-2xl p-6 md:p-8 max-w-md w-full text-center">
                    ...
                    <div class="flex flex-col sm:flex-row justify-center gap-3 mt-6">
                        <button @click="closeDeleteModal()" class="w-full sm:w-auto px-6 py-2.5 bg-gray-200 text-gray-800 font-bold rounded-lg hover:bg-gray-300">Batal</button>
                        <form :action="deleteUrl" method="POST" class="w-full sm:w-auto inline-block">
                            @csrf @method('DELETE')
                            <button type="submit" class="w-full px-6 py-2.5 bg-red-600 text-white font-bold rounded-lg hover:bg-red-700 shadow-md">Hapus</button>
                        </form>
                    </div>
                </div>
            </div>
